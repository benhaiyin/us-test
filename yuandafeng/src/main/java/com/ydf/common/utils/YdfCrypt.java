...
public class YdfCrypt {
	
	 private static final Logger log = LoggerFactory.getLogger(YdfCrypt.class);
   ...
   public static void main(String[] args) {
		String s ="123456";
		String en = YdfCrypt.encryptBasedDes(s);
				
		System.out.println(en);
		
		String de = YdfCrypt.decryptBasedDes(en);
		
		System.out.println(de);
		
		String ss="l+)0%O]Xel^";
		
		System.out.println(YdfCrypt.DKDecrypt("\")&("));
		System.out.println(YdfCrypt.DKEncrypt("123456"));
